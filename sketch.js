var doctorImage1, doctorImage2, doctor, doctorCabinImage, doctorCabin;
var hospitalImage, hospital, receptionImage;
var patient1,patient1Animation,patient1Image,patient1SittingImage, patient2, patient2Animation, patient2Image, patient3, patient3Image, patient4, patient4Image, patient5, patient5Image, patient6, patient6Image, patient7, patient7Image, patient8, patient8Image, patient9, patient9Image, patient10, patient10Image;
...
var ladyImage, lady;
var trainingButtonImg, trainingButton, trainingBackground;
var backButtonImg, backButton;
...
function preload(){
    ...
    trainingBackground = loadImage("medicines.jpg");
    ...
    patient1SittingImage = loadAnimation("man.png");

    patient2Animation = loadAnimation("lady1.png","lady2.png","lady3.png","lady4.png","lady5.png","lady6.png","lady7.png","lady8.png","lady9.png",
    "lady10.png","lady11.png","lady12.png","lady13.png","lady14.png","lady15.png","lady6.png","lady17.png","lady18.png","lady19.png","lady20.png"
    ,"lady21.png","lady22.png","lady23.png","lady24.png");

    patient3Image = loadImage("patient3.png");
    patient4Image = loadImage("patient4.jpg");
    patient5Image = loadImage("patient5.jpg");
    patient6Image = loadImage("patient6.jpg");
    patient7Image = loadImage("patient7.jpg");
    patient8Image = loadImage("patient8.jpg");
    patient9Image = loadImage("patient9.jpg");
    patient10Image = loadImage("patient10.png");

    trainingButtonImg = loadImage("trainingImage.png");

    backButtonImg = loadImage("back_button.jpg");

    doctorCabinImage = loadImage("doctor17.png");

    doctorImage1 = loadAnimation("doctor18.png");
    doctorImage2 = loadAnimation("doctorImage.png");
...
function setup(){
    ...
    enterTheHospital = createSprite(400,200);
    ...
    trainingButton = createSprite(400, 400);
    trainingButton.addImage(trainingButtonImg);
    trainingButton.visible  = false;

    backButton = createSprite(70,550);
    backButton.addImage(backButtonImg);
    backButton.scale = 0.1;
    backButton.visible = false;

    doctorCabin = createSprite(400,300);
    doctorCabin.addImage(doctorCabinImage);
    doctorCabin.visible = false;
    doctorCabin.scale = 0.5;

    doctor = createSprite(700,358);
    doctor.addAnimation("sit", doctorImage1);
    doctor.addAnimation("stand", doctorImage2);
    doctor.scale = 0.7;
    doctor.visible = false;

    patient1 = createSprite(820,305);
    var rand = Math.round(random(1,2));
    switch(rand){
    case 1 : patient1.addAnimation("walk", patient1Animation);
             patient1.addAnimation("sit", patient1SittingImage);
             patient1.scale = 0.5;
            break;
    case 2 : patient1.addAnimation("walking", patient2Animation);
             patient1.scale = 0.4;
            break;
    default : break;
    }
...
function draw(){
    ...
    if(gameState === 1 && city.scale < 0){
        ...
        if(mousePressedOver(trainingButton) && gameState === 1 ){
            gameState = -1;
    ...
    if(gameState === -1){
        ...
        push();
        visiblity2 = visiblity2 + 3;
        tint(255, visiblity2);
        imageMode(CENTER);
        image(trainingBackground, 400, 300);
        pop();
        ...
        if(visiblity2 >=255){
            ...
            fill("black");
            stroke("black");
            text("CORONA : COVISHIELD", 200,200);
            text("FEVER : DOLO", 200,300);
            text("HEADACHE : COMBIFLAME", 200,400);
            pop();
        }
    ...
    if(gameState === 2 && patient1.x <= 190){
        ...
        if(number > 100 && number<200){
            ...
            stroke("lightblue");
            fill("lightblue");
            text("I want to meet the",200,200);
            text("doctor.",200,220);
        ...
        if(number > 200 && number < 300){
            ...
            stroke("lightblue");
            fill("lightblue");
            text("OK, you can go in.",120,210);

        }

        if(number > 300 && number < 360){
        ...
        if(number>360){
            cloud.visible = false;
            gameState = 3;
            patient1.mirrorX(patient1.mirrorX() * -1);
            patient1.x = 20;
            patient1.y = 360;
    ...
    if(gameState === 3){
        doctorCabin.visible = true;
        doctor.visible = true;
        lady.visible = false;
        patient1.depth = doctorCabin.depth;
        patient1.depth = patient1.depth + 1;
        patient1.scale = 0.7;
        patient1.velocityX = 2;
        doctor.changeAnimation("stand", doctorImage2);

        if(patient1.x >= 537){
            patient1.velocityX = 0;
            patient1.changeAnimation("sit", patient1SittingImage);
            doctor.changeAnimation("sit", doctorImage2);
...
function chat(){
    ...
    switch(rand){
        case 1 : text("hello", 400,300);
                break;

        case 2 : text("hi", 500,300);
                break;

        case 3 : text("bonjour", 200,300);
                break;
